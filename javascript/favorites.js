...
export class FavoritesView extends Favorites {
  constructor(root) {
    ...
    this.tbody = this.root.querySelector('.content-box table tbody')
  ...
  NoEntries() {
    this.entries.length === 0
      ? document.querySelector('.without-entries').classList.remove('sr-only')
      : document.querySelector('.without-entries').classList.add('sr-only')
  }
  ...
  createRow() {
    ...
    <td class="user">
    <img
    src="https://github.com/Luizfpsvn.png"
    alt="Luiz Fernando image"
    />
    <a href="https://github.com/Luizfpsvn" target="_blank">
    <p>Luiz Fernando</p>
    <span>/Luizfpsvn</span>
        </a>
        </td>
